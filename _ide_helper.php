 ...
 * Generated for Laravel 5.5.32 on 2018-04-11.
 *
...
namespace Illuminate\Support\Facades { 
    ...
    class Queue {
        ...
        {
            return \Illuminate\Queue\QueueManager::size($queue);
        }
        ...
        {
            return \Illuminate\Queue\QueueManager::push($job, $data, $queue);
        }
        ...
        {
            return \Illuminate\Queue\QueueManager::pushOn($queue, $job, $data);
        }
        ...
        {
            return \Illuminate\Queue\QueueManager::pushRaw($payload, $queue, $options);
        }
        ...
        {
            return \Illuminate\Queue\QueueManager::later($delay, $job, $data, $queue);
        }
        ...
        {
            return \Illuminate\Queue\QueueManager::laterOn($queue, $delay, $job, $data);
        }
        ...
        {
            return \Illuminate\Queue\QueueManager::bulk($jobs, $data, $queue);
        }
        ...
        {
            return \Illuminate\Queue\QueueManager::pop($queue);
        }
        ...
        {
            return \Illuminate\Queue\QueueManager::getConnectionName();
        }
        ...
        {
            return \Illuminate\Queue\QueueManager::setConnectionName($name);
        }
